...
const CREDENTIAL_VARIABLE: &str = sophon_sdk::CONFORMANCE_CREDENTIAL_VARIABLE;
const CREDENTIAL_HANDLE: &str = sophon_sdk::CONFORMANCE_CREDENTIAL_HANDLE;
...
fn a_backend_that_fabricates_success_for_an_orphan_fails_the_conformance() {
    ...
    impl ProgramRuntime for OptimisticRuntime {
        ...
        fn wait(
            &self,
            execution: &ExecutionId,
        ) -> Result<sophon_sdk::ExecutionReceipt, ProgramError> {
